...
outputdir = "/proj/hyejunglab/crossdisorder/LDSC/partherit/SCZ_expression/DEG_coexp_HiC/"
setwd(outputdir)
...
outdir = "/proj/hyejunglab/crossdisorder/LDSC/partherit/SCZ_expression/DEG_coexp_HiC/"
condition = "scz3"
isoforms = paste0("geneM",1:34)
...
plot1 = ggplot(isoAsso,aes(Group,Module)) + geom_tile(aes(fill=Odds.Ratio), colour="grey") + coord_fixed(ratio=1) + scale_fill_gradient2(low="steelblue", mid="white", high="indianred", midpoint=0) + ylab("Isoform Module")
...
pdf("gene_coexp_CMC_QTL.pdf", height=10, width=10)
